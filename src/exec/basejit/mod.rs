...
impl<C: CellType> BaseJitCompiler<C> {
    ...
    pub fn print_mc(&self, limit: bool, safe: bool) -> Vec<u8> {
        self.compile_program(limit, safe)
    }

    /// Generate, from the bytecode, the corresponding machine code.
    fn compile_program(&self, limited: bool, safe: bool) -> Vec<u8> {
        ...
        code_gen.emit_program(&self.bytecode, limited, safe);
